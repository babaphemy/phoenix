...
<div class="row-fluid" ng-controller="zonesController">
    ...
    <h4>
        <div ng-class="{'': state == 'list', 'none': state != 'list'}">
            <p class="text-center">
                <spring:message code="message.total.records.found"/>:&nbsp;{{page.totalZones}}
            </p>
        </div>
    </h4>
    ...
    <div>
        <div id="loadingModal" class="modal hide fade in centering"
             role="dialog"
             aria-labelledby="deleteZonesModalLabel" aria-hidden="true">
        ...
        <div ng-class="{'alert alert-info': state == 'noresult', 'none': state != 'noresult'}">
            <h4><i class="icon-info-sign"></i> <spring:message code="zones.emptyData"/></h4><br/>

            <p><spring:message code="zones.emptyData.text"/></p>
        </div>
                ...
                <tr ng-repeat="zone in zone">
                    ...
                    <td class="width15">
                        <div class="text-center">
                            <input type="hidden" value="{{zone.zid}}"/>
                            <a href="#updateZonesModal"
                               ng-click="selectedZone(zone);"
                               role="button"
                               title="<spring:message code="update"/>&nbsp;<spring:message code="zone"/>"
                               class="btn btn-inverse" data-toggle="modal">
                                <i class="icon-pencil"></i>
                            </a>
                            <a href="#deleteZonesModal"
                               ng-click="selectedZone(zone);"
                               role="button"
                               title="<spring:message code="delete"/>&nbsp;<spring:message code="zone"/>"
                               class="btn btn-inverse" data-toggle="modal">
        ...
        <div ng-class="{'text-center': displayCreateZoneButton == true, 'none': displayCreateZoneButton == false}">
            <br/>
            <a href="#addZonesModal"
               role="button"
               ng-click="resetZone();"
               title="<spring:message code='create'/>&nbsp;<spring:message code='zone'/>"
               class="btn btn-inverse"
               data-toggle="modal">
                <i class="icon-plus"></i>
        ...
        <jsp:include page="dialogs/zonesDialogs.jsp"/>
